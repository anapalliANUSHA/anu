	...
	public class DBMDriverDetails {
	    ...
	    public static void main(String[] args) {
	        ...
	        try {
	            ...
	            System.out.println("Column classname: " + rsmd.getColumnTypeName(1));
	            
	            System.out.println("Display Size: " + rsmd.getColumnDisplaySize(1));
	            
	            System.out.println("Column Name: " + rsmd.getColumnDisplaySize(1));
	            
	            System.out.println("Column Type: " + rsmd.getColumnDisplaySize(1));
